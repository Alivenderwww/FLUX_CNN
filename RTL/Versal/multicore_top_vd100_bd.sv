...
module multicore_top_vd100_bd (
    ...
    logic [3*5-1:0]    iw_awid,    iw_arid,    iw_bid,    iw_rid;
    ...
    // ===== M00 → packed vector slot 0 =====
    assign m00_axi_awid    = iw_awid    [0*5  +:5];   assign m00_axi_arid    = iw_arid    [0*5  +:5];
    ...
    assign iw_bid[0*5 +:5] = m00_axi_bid;             assign iw_bresp[0*2 +:2] = m00_axi_bresp;
    assign iw_bvalid[0]    = m00_axi_bvalid;          assign m00_axi_bready  = iw_bready  [0];
    assign iw_rid[0*5 +:5] = m00_axi_rid;             assign iw_rdata[0*128 +:128] = m00_axi_rdata;
    ...
    // ===== M01 → packed vector slot 1 =====
    assign m01_axi_awid    = iw_awid    [1*5  +:5];   assign m01_axi_arid    = iw_arid    [1*5  +:5];
    ...
    assign iw_bid[1*5 +:5] = m01_axi_bid;             assign iw_bresp[1*2 +:2] = m01_axi_bresp;
    assign iw_bvalid[1]    = m01_axi_bvalid;          assign m01_axi_bready  = iw_bready  [1];
    assign iw_rid[1*5 +:5] = m01_axi_rid;             assign iw_rdata[1*128 +:128] = m01_axi_rdata;
    ...
    // ===== M02 → packed vector slot 2 =====
    assign m02_axi_awid    = iw_awid    [2*5  +:5];   assign m02_axi_arid    = iw_arid    [2*5  +:5];
    ...
    assign iw_bid[2*5 +:5] = m02_axi_bid;             assign iw_bresp[2*2 +:2] = m02_axi_bresp;
    assign iw_bvalid[2]    = m02_axi_bvalid;          assign m02_axi_bready  = iw_bready  [2];
    assign iw_rid[2*5 +:5] = m02_axi_rid;             assign iw_rdata[2*128 +:128] = m02_axi_rdata;

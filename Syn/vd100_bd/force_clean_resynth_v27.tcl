...
# v27: mm2s_arb 去掉 sts gate (板 axi_dm sts 行为跟 sim 不同 → 死锁), idma_sg_dispatcher r_done 不依赖 sts
puts "=== v27: revert sts gate, idma_dispatcher cmd_idx-based done ==="

# v25 已删 ila_dbg, 沿用. 仅 RTL change.
puts "=== reset all runs ==="
reset_runs synth_1
reset_runs impl_1

...
# v29: ODMA + IDMA dispatcher r_done 不依赖 axi_dm sts (board 上 sts 偶尔不出卡死).
# + 沿用 v28 4KB-split fix (IDMA dispatcher).
puts "=== v29: ODMA streaming_all_done 用 data tlast / IDMA r_done 用 cmd_idx ==="

...
\node[panel title, anchor=north] at ($(pA.north)+(0,-2mm)$) {Weight-Stationary};
...
\node[panel title, anchor=north] at ($(pB.north)+(0,-2mm)$) {Output-Stationary};
...
\node[panel title, anchor=north] at ($(pC.north)+(0,-2mm)$) {Row-Stationary};

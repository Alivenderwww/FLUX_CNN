...
resnet11_layers = [
    ...
    # 真实 FR-Net: Patch + 3 残差块(每块 2 conv + 1 条 1x1 降采样) + FC, 与 benchmark_networks.py 一致
    (4, 4, 4,   16, 540, 960, 0, "Patch"),
    (3, 2, 16,  16, 135, 240, 1, "L1_C1"),   # stride 2, 135->68
    (3, 1, 16,  16,  68, 120, 1, "L1_C2"),
    (1, 2, 16,  16, 135, 240, 0, "L1_ds"),   # 1x1 降采样残差
    (3, 2, 16,  32,  68, 120, 1, "L2_C1"),
    (3, 1, 32,  32,  34,  60, 1, "L2_C2"),
    (1, 2, 16,  32,  68, 120, 0, "L2_ds"),
    (3, 2, 32,  64,  34,  60, 1, "L3_C1"),
    (3, 1, 64,  64,  17,  30, 1, "L3_C2"),
    (1, 2, 32,  64,  34,  60, 0, "L3_ds"),

...
module tb_core_dma;
    ...
    core_top #(
        ...
        // M2: 跨核 IFB SI 端口 tie-off (单核 TB 不用跨核 push)
        .rmt_ifb_awid('0), .rmt_ifb_awaddr('0), .rmt_ifb_awlen('0),
        .rmt_ifb_awsize('0), .rmt_ifb_awburst('0),
        .rmt_ifb_awlock(1'b0), .rmt_ifb_awcache('0), .rmt_ifb_awprot('0), .rmt_ifb_awqos('0),
        .rmt_ifb_awvalid(1'b0), .rmt_ifb_awready(),
        .rmt_ifb_wdata('0), .rmt_ifb_wstrb('0), .rmt_ifb_wlast(1'b0),
        .rmt_ifb_wvalid(1'b0), .rmt_ifb_wready(),
        .rmt_ifb_bid(), .rmt_ifb_bresp(), .rmt_ifb_bvalid(), .rmt_ifb_bready(1'b0),
        .rmt_ifb_arid('0), .rmt_ifb_araddr('0), .rmt_ifb_arlen('0),
        .rmt_ifb_arsize('0), .rmt_ifb_arburst('0),
        .rmt_ifb_arlock(1'b0), .rmt_ifb_arcache('0), .rmt_ifb_arprot('0), .rmt_ifb_arqos('0),

# =============================================================================
# tb_mesh/run_top_mesh_smoke.tcl  --  multicore_top_mesh smoke
# 需要: axi_dm + axi_lite_1to4 IP (复用 tb_multicore env)
# =============================================================================
...
vlog -sv -work work -mfcu -suppress 2902,13314 \
    ...
    tb_multicore_top_mesh_smoke.sv
...
vsim -c -voptargs="+acc" \
    ...
    -L unisims_ver \
    work.tb_multicore_top_mesh_smoke xil_defaultlib.glbl
run -all
quit -f

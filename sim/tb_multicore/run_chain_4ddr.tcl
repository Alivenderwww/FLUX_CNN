# =============================================================================
# tb_multicore/run_chain_4ddr.tcl  --  4-DDR PoC variant
#
# 跑 multicore_top_4ddr (N=4 固定, 4 个独立 DDR master) + tb_multicore_4ddr_chain.
# 用 axi_4to8 crossbar (Syn/gen_multicore_4ddr_ip.tcl 生成) 替代 axi_4to5.
# 其他 IP (axi_dm / axi_lite_1to4) 跟原 run_chain.tcl 共用.
# =============================================================================
...
set IP_AGG_DIR  {C:/_Project/FLUX_CNN/Syn/ip_managed/ip_managed.gen/sources_1/ip/axi_4to8}
...
vlog -sv -work work -mfcu -suppress 2902,13314 \
    ...
    ../../RTL/ofb_writer.sv \
    ../../RTL/core_top.sv \
    ../../RTL/multicore_top_4ddr.sv \
    ../tb_axi_m_mux/axi_slave_mem.sv \
    tb_multicore_4ddr_chain.sv
...
vsim -c -voptargs="+acc" \
    ...
    -L unisims_ver \
    work.tb_multicore_chain xil_defaultlib.glbl
run -all
quit -f

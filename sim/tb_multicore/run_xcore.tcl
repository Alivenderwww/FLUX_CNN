# =============================================================================
# tb_multicore/run_xcore.tcl  --  M2 跨核流水线 (NUM_CORES=2) Modelsim run
# =============================================================================
...
# axi_2to3 + axi_lite_1to2 IPs
vlog -work xil_defaultlib \
    "$IP_AGG_DIR/sim/axi_2to3.v"
vlog -work xil_defaultlib \
    "$IP_CSR_DIR/sim/axi_lite_1to2.v"

# 项目 RTL + multicore_top + xcore TB
...
vsim -c -voptargs="+acc" \
    ...
    -L unisims_ver \
    work.tb_multicore_xcore xil_defaultlib.glbl
run -all
quit -f

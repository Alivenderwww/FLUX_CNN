# =============================================================================
# tb_smc/run_chain.tcl  --  Phase 7 SMC + NUMA chain sim
#   跑 toolchain/run_multicore_chain.py --smc 生成的 case 目录
#   DUT: multicore_top_smc (4 ConvCore + axi_crossbar_4to4_sim + 4 mem)
# =============================================================================
...
vsim -c -voptargs="+acc" \
    ...
    -L unisims_ver \
    +CASE_DIR=cases/smc_resnet11 work.tb_smc_chain xil_defaultlib.glbl
run -all
quit -f
